...
function americanToCents(odds) {
  ...
  /*
   * Converts American odds into a continuous
   * "cents from even money" scale.
   *
   * -120 -> -20
   * -105 ->  -5
   * +100 ->   0
   ...
   *
   * So:
   * -120 -> -105 = 15 cents better
   * -110 -> +105 = 15 cents better
   */
...
function isBetterQuote(
  ...
  // SPREAD / RUNLINE
  //
  // Higher number is always better for selected side:
  //
  // +3.5 > +3
  // -2.5 > -3.5
  // ==========================================================
...
module.exports =
  async function handler(
    ...
    try {
      ...
      /*
       * Price comparison is only valid when
