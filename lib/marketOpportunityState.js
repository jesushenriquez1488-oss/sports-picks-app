...
// ==========================================================
// TRANSIENT MARKET SPLIT
//
// Sportsbooks can update sequentially and temporarily create
// a split market while a provider batch is still settling.
//
// Do not break an active opportunity lifecycle because of this
// intermediate state.
// ==========================================================

if (
  newState === "MARKET_SPLIT" &&
  (
    oldState === "VALUE_AVAILABLE" ||
    oldState === "WINDOW_CLOSING"
  )
) {
  return {
    ok: true,
    ...
    transientMarketSplit:
      true,

    reason:
      "Transient market split ignored while opportunity lifecycle remains active",
