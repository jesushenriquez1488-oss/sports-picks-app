...
// RETRY-AFTER
//
// Si OneSignal devuelve 429 / 5xx y además indica cuándo
// podemos volver a intentar, devolvemos ese tiempo al worker.
// ============================================================
...
async function sendOneSignalPush({
  ...
  // IDEMPOTENCY
  //
  // El worker enviará siempre el mismo UUID para una delivery.
  //
  // Ejemplo:
  //
  // 1. OneSignal recibe el push.
  // 2. OneSignal lo envía.
  // 3. La respuesta se pierde por timeout.
  // 4. Nuestro worker reintenta.
  //
  // Al usar la misma idempotency_key, OneSignal no debe
  // generar una segunda notificación distinta.
  // ==========================================================
  ...
  try {
    ...
    //
    // OneSignal puede aceptar HTTP 200 y no devolver ID
    // cuando no existe una subscription válida a la cual
    // entregar el mensaje.
    // ========================================================
