...
async function handleMovementMilestone({
  ...
  // MLB RUNLINE / SPREAD
  //
  // Do not create movement milestones from MLB runline.
  // A favorite/underdog flip can mechanically change
  // +1.5 to -1.5 and create false 3-run movement noise.
  //
  // MLB team-side movement will be evaluated through Moneyline.
  // ==========================================================
  ...
  if (
    ...
    return {
      ...
      reason:
        "MLB runline movement excluded; team-side movement uses Moneyline"
    };
  }
