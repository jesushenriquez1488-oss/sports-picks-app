...
async function processOneMarketNotificationDelivery({
  ...
  try {
    ...
    // OWNERSHIP LOST
    //
    // Otro worker o una recuperación tomó control.
    // No tocamos más esta delivery.
    // ========================================================
    ...
    //
    // validate_market_notification_delivery_v1 es la autoridad
    // para decidir que ya no debe enviarse.
    // ========================================================
    ...
    // CUSTOM DATA
    //
    // deepLink queda también en data para que posteriormente
    // Web / Android puedan abrir Premium Radar exactamente en
    ...
    // obligando a que esta delivery quede terminal y no vuelva
    // a enviarse indefinidamente.
    // ========================================================
