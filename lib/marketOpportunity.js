const MIN_BOOKS_FOR_OPPORTUNITY = 3;
const MIN_BETTER_PRICE_CENTS = 5;
const MIN_CONSENSUS_SHARE = 0.60;
...
function getBestBooks(
  ...
  // MONEYLINE
  //
  // There is no separate line.
  // Keep every sportsbook tied at the exact best price.
  // ==========================================================
  ...
  if (
    ...
    // SPREAD / TOTAL
    //
    // Keep EVERY sportsbook offering the exact best line.
    // Price does NOT remove a book from this group.
    // Books at the same best line are sorted by best price.
    // ========================================================
...
async function calculateMarketOpportunity({
  ...
  // ==========================================================
  // ALL SPORTSBOOKS AT THE BEST AVAILABLE NUMBER
  //
  // Spread / Total:
  // Keep every book at the exact best line.
  // Sort those books by best American price.
  //
  // Moneyline:
  // Keep every book tied at the exact best price.
  // ==========================================================
