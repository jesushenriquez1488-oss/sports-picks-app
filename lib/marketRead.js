...
const meaningfulWith =
  directionalScores.some(
    value =>
      value >= 10
  );


const meaningfulAgainst =
  directionalScores.some(
    value =>
      value <= -10
  );
...
// ==========================================================
// MATERIAL COMPONENT CONFLICT
//
// The final Sharp Score can be near zero because meaningful
// evidence in opposite directions cancels mathematically.
//
// Example:
//
// Money/Tickets      -29
...
// Breadth            +15
//
// Final score may be small, but the market is NOT quiet.
// ==========================================================
...
if (
  ...
  return {
    ...
    explanation:
      "Meaningful market evidence is currently pointing in opposite directions, so there is no clear directional edge.",
...
// ==========================================================
// SHARP EVIDENCE EXISTS, BUT NO CLEAR DIRECTION
// ==========================================================
...
if (
  ...
  return {
    ...
    explanation:
      "Meaningful Sharp evidence is present, but the current market evidence is not strong or consistent enough for a clear directional read.",
