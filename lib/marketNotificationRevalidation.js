...
// ==========================================================
// 24-HOUR DELIVERY SAFETY
//
// Even if the notification was created earlier, re-check
// the real game time immediately before fanout.
//
// This also protects against postponed/rescheduled games.
// ==========================================================
...
if (
  ...
  return cancelNotificationOwnerSafe({
    ...
    reason:
      `Notification outside 24-hour game window: ${
        notificationGameWindow.reason
      }`
  });
}
  // ==========================================================
  ...
  if (
    ...
    if (!sourceEvent) {
      ...
      return cancelNotificationOwnerSafe({
        ...
        reason:
          "Original Market Reversal signal no longer exists"
      });
    }
    ...
    if (
      ...
      return cancelNotificationOwnerSafe({
        ...
        reason:
          "Market Reversal signal is no longer active"
      });
    }
    ...
    if (
      ...
      return cancelNotificationOwnerSafe({
        ...
        reason:
          "Strong Sharp reversal against CashEdge is no longer confirmed"
      });
    }
  }
  ...
  // STRONG_SHARP and MARKET_REVERSAL use their original active
